...
$pdf->Cell(59	,5,'LISTA DE ASITENCIAS',0,1);//end of line
$pdf->Cell(189	,10,'',0,1);//end of line
...
$query = $db->prepare("SELECT t1.fecha, t2.cedula, concat(t2.primerNombre, ' ', t2.segundoNombre, ' ', t2.primerApellido, ' ', t2.segundoApellido) as eply,
                                    ...
                                    FROM asist_entrada t1 
                                        INNER JOIN empleados t2 ON t1.empleadoId = t2.id
                                        INNER JOIN tipo_llegada t3 ON t1.tipoId = t3.id
...
foreach((array) $all as $item){
	...
	$pdf->Cell(30	,5,$item['nombre'],0,0);
	$pdf->Cell(189	,0,'',0,1);//end of line
	$pdf->Cell(100	,8,' _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,1);//end of line
}
$pdf->Output();